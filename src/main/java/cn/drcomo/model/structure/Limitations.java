...
public class Limitations {
    ...
    // 初始值更新限制
    private final Boolean strictInitialMode;
    ...
    private Limitations(Builder builder) {
        ...
        this.strictInitialMode = builder.strictInitialMode;
    }
    ...
    public Boolean getStrictInitialMode() {
        return strictInitialMode;
    }
    ...
    public boolean hasBehaviorLimitations() {
        return readOnly != null || persistable != null || exportable != null || strictInitialMode != null;
    }
    ...
    public boolean isStrictInitialMode() {
        return strictInitialMode != null && strictInitialMode;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(minValue, that.minValue) &&
               ...
               Objects.equals(strictInitialMode, that.strictInitialMode);
    }
    ...
    public String toString() {
        return "Limitations{" +
                ...
                ", strictInitialMode=" + strictInitialMode +
                '}';
    }
    ...
    public static class Builder {
        ...
        private Boolean strictInitialMode;
        ...
        public Builder strictInitialMode(Boolean strictInitialMode) {
            this.strictInitialMode = strictInitialMode;
            return this;
        }
     ...
     * 创建严格初始值模式限制条件
     */
    public static Limitations strictInitial() {
        return new Builder().strictInitialMode(true).build();
    }
}